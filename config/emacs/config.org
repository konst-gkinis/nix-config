...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Konstantinos Gkinis"
    user-mail-address "konst.gkinis@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/kg/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/kg/bin" "/profile/bin" "/Users/kg/.npm-packages/bin" "/Users/kg/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
